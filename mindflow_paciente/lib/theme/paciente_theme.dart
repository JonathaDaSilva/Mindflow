...
/// Tema light wellness exclusivo do app do paciente.
/// Identidade teal/verde — calmo, acolhedor, saúde mental.
class PcT {
  PcT._();
  ...
  static const Color accent       = Color(0xFF6366F1); // indigo (agendamento)
  static const Color accentLight  = Color(0xFFEEF0FD);
  static const Color emergency    = Color(0xFFDC2626); // vermelho emergência
  ...
  static Color statusBg(String? s) {
    switch (s) {
      ...
      case 'EM_ANDAMENTO': return accentLight;
  ...
  static Color statusFg(String? s) {
    switch (s) {
      ...
      case 'EM_ANDAMENTO': return accent;
      case 'CONCLUIDA':    return purple;
  ...
  static String statusLabel(String? s) {
    switch (s) {
      case 'SOLICITADA':   return 'Aguardando';
  ...
  static IconData statusIcon(String? s) {
    switch (s) {
      ...
      case 'EM_ANDAMENTO': return Icons.play_circle_outline_rounded;
  ...
  static ThemeData get theme => ThemeData(
    ...
    appBarTheme: const AppBarTheme(
      ...
      titleTextStyle: TextStyle(
        color: text1, fontSize: 18, fontWeight: FontWeight.w600, fontFamily: 'Inter',
      ),
    ...
    inputDecorationTheme: InputDecorationTheme(
      ...
      border: OutlineInputBorder(borderRadius: BorderRadius.circular(12), borderSide: const BorderSide(color: border, width: 1)),
